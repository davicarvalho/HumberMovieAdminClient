...
<html>
    ...
    <body class="text-center">
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <form method="POST" action="/My-IMDb-admin-web-client/AddTvShow">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <input type="text" class="form-control" id="year" name="yearStart" placeholder="yearStart">
                        </div>
                    </div>
                     <div class="form-group row">
                        <label for="name" class="col-sm-2 col-form-label">Year End</label>
                        <div class="col-sm-10">
                           <input type="text" class="form-control" id="year" name="yearEnd" placeholder="yearEnd">
                        </div>
                    </div>
                    <div class="form-group row">
