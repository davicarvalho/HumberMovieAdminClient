...
<html>
    ...
    <body class="text-center">
        ...
        <script>
            const addItem = () => {
                location = "/My-IMDb-admin-web-client/AddSeason"
            }
            const updateItem = (id) => {
                location = "/My-IMDb-admin-web-client/UpdateSeason?id="+id
            }
             const deleteItem = (id) => {
                location = "/My-IMDb-admin-web-client/DeleteSeason?id="+id
            }
        </script>
    </body>
</html>
