...
<html>
    ...
    <body class="text-center">
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <form method="POST" action="/My-IMDb-admin-web-client/UpdateMovie">
                    <input type="hidden" class="form-control" id="id" name="id" value="${movie.id}">
                    <div class="form-group row">
                        <label for="name" class="col-sm-2 col-form-label">Title</label>
                        <div class="col-sm-10">
                           <input type="text" class="form-control" id="title" name="title" placeholder="Title" value="${movie.title}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="name" class="col-sm-2 col-form-label">Year</label>
                        <div class="col-sm-10">
                           <input type="text" class="form-control" id="year" name="year" placeholder="Year" value="${movie.year}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="genre">
                                <c:forEach items="${genres}" var="item">
                                    <c:if test = "${movie.genreid.id == item.id}">
