...
<html>
    ...
    <body class="text-center">
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                      <c:forEach items="${episodes}" var="item">
                        <tr>
                          <td scope="row"> ${item.id}</td>
                          <td> ${item.title}</td>
                          <td> ${item.episodeNumber}</td>
                          <td> ${item.seasonid.showid.title} - ${item.seasonid.title}</td>
        ...
        <script>
            const addItem = () => {
                location = "/My-IMDb-admin-web-client/AddEpisode"
            }
            const updateItem = (id) => {
                location = "/My-IMDb-admin-web-client/UpdateEpisode?id="+id
            }
             const deleteItem = (id) => {
                location = "/My-IMDb-admin-web-client/DeleteEpisode?id="+id
            }
        </script>
    </body>
</html>
